...
import { Briefcase, FileText, Calendar, CheckCircle, ExternalLink, Mail, Phone, User } from "lucide-react"
          ...
          <div className="bg-primary-lighter rounded-2xl border border-border p-6 shadow-lg">
             ...
             {company.notes && (
                <div className="mt-6 pt-4 border-t border-border">
                  <p className="text-xs text-muted font-semibold uppercase mb-2">Internal Notes</p>
