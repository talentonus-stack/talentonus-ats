    ...
    <div className="max-w-3xl animate-fade-in mx-auto">
      ...
      <form action={createCompany} className="bg-primary-lighter p-8 rounded-2xl shadow-xl border border-border">
        ...
        <div className="mt-8 flex justify-end gap-4 border-t border-border pt-8">
          ...
          <button type="submit" className="rounded-lg bg-accent px-5 py-2.5 text-sm font-bold text-primary hover:bg-[#E8952C] hover:scale-[1.02] transition-all duration-200 shadow-md hover:shadow-lg">
            Save Company
          </button>
        </div>
      </form>
